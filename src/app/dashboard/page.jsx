...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-green-500 flex flex-col font-sans">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <button 
              ...
              className="bg-red-900 hover:bg-red-800 text-white py-1 px-3 rounded text-sm"
            >
              {t('LOGOUT')}
            </button>
          </div>
      ...
      <main className="flex-grow container mx-auto p-4">
        {!systemsInitialized ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-900 border border-green-700 rounded-md p-3">
            ...
            <div className="bg-gray-900 border border-green-700 rounded-md col-span-1 md:col-span-2 lg:col-span-3 p-3">
